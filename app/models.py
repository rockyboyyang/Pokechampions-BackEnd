...
class User(MixinAsDict, db.Model):
    ...
    slot_1 = db.Column(db.String(30), nullable=True)
    slot_2 = db.Column(db.String(30), nullable=True)
    slot_3 = db.Column(db.String(30), nullable=True)
    slot_4 = db.Column(db.String(30), nullable=True)
    slot_5 = db.Column(db.String(30), nullable=True)
    slot_6 = db.Column(db.String(30), nullable=True)
...
class Trainer(MixinAsDict, db.Model):
    ...
    slot_1 = db.Column(db.String(30), nullable=False)
    slot_2 = db.Column(db.String(30), nullable=False)
    slot_3 = db.Column(db.String(30), nullable=False)
    slot_4 = db.Column(db.String(30), nullable=False)
    slot_5 = db.Column(db.String(30), nullable=False)
    slot_6 = db.Column(db.String(30), nullable=False)
